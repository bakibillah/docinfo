...
command = "google-chrome --user-data-dir=$HOME/docinfo8 --proxy-server=138.197.224.38:15582 --remote-debugging-port=9222 --remote-allow-origins=http://localhost:9222"

...
command = "google-chrome --user-data-dir=$HOME/lteboost-1033 --proxy-server=65.21.25.28:1033 --remote-debugging-port=1033 --remote-allow-origins=http://localhost:1033"

...
def run_scraper(count_):
    command = "google-chrome --user-data-dir=$HOME/proxy34new --proxy-server=138.197.224.38:16234 --remote-debugging-port=9234 --remote-allow-origins=http://localhost:9234"

...
command = "google-chrome --user-data-dir=$HOME/proxy36 --proxy-server=138.197.224.38:16236 --remote-debugging-port=9236 --remote-allow-origins=http://localhost:9236"
chrome_process = subprocess.Popen(command, shell=True, stdin=subprocess.DEVNULL, stdout=subprocess.DEVNULL,
                                  stderr=subprocess.DEVNULL, close_fds=True)
time.sleep(5)

chrome = PyChromeDevTools.ChromeInterface(port=9236)

...
command = "google-chrome --user-data-dir=$HOME/16623 --proxy-server=138.197.224.38:16623 --remote-debugging-port=16623 --remote-allow-origins=http://localhost:16623"
...
while break_while:
    ...
    for doc_id in all_doc_id:
        ...
        try:
            res = session.get(
                burp0_url,
                proxy="http://138.197.224.38:16623",

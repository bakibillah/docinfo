...
command = "google-chrome --user-data-dir=$HOME/proxy34-new --proxy-server=65.21.25.28:1037 --remote-debugging-port=9234 --remote-allow-origins=http://localhost:9234"
# command = "google-chrome --user-data-dir=$HOME/proxy34-new --proxy-server=138.197.224.38:16624 --remote-debugging-port=9234 --remote-allow-origins=http://localhost:9234"
...
chrome = PyChromeDevTools.ChromeInterface(port=9234)
